...
struct DevServersView: View {
  ...
  private var enterUrl: some View {
        ...
        TextField("http://10.0.0.25:8081", text: $urlText)
          ...
          .overlay(
            RoundedRectangle(cornerRadius: 5)
              .stroke(Color.expoSystemColors.systemGray4.color, lineWidth: 1)
          )
        #endif
    ...
    .background(showingURLInput ?
      Color.expoSystemColors.secondarySystemBackground.color :
      Color.expoSystemColors.systemBackground.color)
